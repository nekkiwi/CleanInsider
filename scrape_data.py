...
def main(num_weeks: int, target_only: bool):
    ...
    target_combinations = [
        ...
        # {'time': '2m', 'tp': 0.05, 'sl': -0.05},
        # {'time': '2m', 'tp': 0.05, 'sl': -0.10},
        # {'time': '2m', 'tp': 0.10, 'sl': -0.10},
        # {'time': '2m', 'tp': 0.10, 'sl': -0.05},
        # {'time': '2m', 'tp': 0.15, 'sl': -0.05},
        # {'time': '2m', 'tp': 0.15, 'sl': -0.10},

        # {'time': '3m', 'tp': 0.05, 'sl': -0.05},
        # {'time': '3m', 'tp': 0.05, 'sl': -0.10},
        # {'time': '3m', 'tp': 0.10, 'sl': -0.10},
        # {'time': '3m', 'tp': 0.10, 'sl': -0.05},
        # {'time': '3m', 'tp': 0.15, 'sl': -0.05},
        # {'time': '3m', 'tp': 0.15, 'sl': -0.10},

        # {'time': '4m', 'tp': 0.05, 'sl': -0.05},
        # {'time': '4m', 'tp': 0.05, 'sl': -0.10},
        # {'time': '4m', 'tp': 0.10, 'sl': -0.10},
        # {'time': '4m', 'tp': 0.10, 'sl': -0.05},
        # {'time': '4m', 'tp': 0.15, 'sl': -0.05},
        # {'time': '4m', 'tp': 0.15, 'sl': -0.10},

        # {'time': '5m', 'tp': 0.05, 'sl': -0.05},
        # {'time': '5m', 'tp': 0.05, 'sl': -0.10},
        # {'time': '5m', 'tp': 0.10, 'sl': -0.10},
        # {'time': '5m', 'tp': 0.10, 'sl': -0.05},
        # {'time': '5m', 'tp': 0.15, 'sl': -0.05},
        # {'time': '5m', 'tp': 0.15, 'sl': -0.10},

        # {'time': '6m', 'tp': 0.05, 'sl': -0.05},
        # {'time': '6m', 'tp': 0.05, 'sl': -0.10},
        # {'time': '6m', 'tp': 0.10, 'sl': -0.10},
        # {'time': '6m', 'tp': 0.10, 'sl': -0.05},
        # {'time': '6m', 'tp': 0.15, 'sl': -0.05},
        # {'time': '6m', 'tp': 0.15, 'sl': -0.10},
    ]
