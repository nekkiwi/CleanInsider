    ...
    def run(self, strategies, binary_thresholds_pct, model_type, top_n, seeds):
        ...
        for seed, strategy, bin_thresh in tqdm(combinations, desc="Processing Strategies"):
            ...
            for fold in range(1, self.num_folds + 1):
                ...
                val_metrics = evaluate_fold(classifier, regressor, X_val_sel, y_bin_val, y_cont_val)
                if val_metrics:
                ...
                if test_df is not None:
                    ...
                    if X_test is not None:
                        ...
                        test_metrics = evaluate_fold(classifier, regressor, X_test_sel, y_bin_test, y_cont_test)
                        if test_metrics:
